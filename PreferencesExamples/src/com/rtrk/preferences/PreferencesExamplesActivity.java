...
public class PreferencesExamplesActivity extends Activity {
	...
	protected static final String TAG = "PreferencesExamplesActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getApplicationContext(), "Login with " + username + "/" + password, Toast.LENGTH_LONG).show();
			}
		});
        ...
        btnChange.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(getApplicationContext(), PreferencesDialog.class);
				startActivity(i);
			}
		});
