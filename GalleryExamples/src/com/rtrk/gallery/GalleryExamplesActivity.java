...
public class GalleryExamplesActivity extends Activity {
    ...
    public void showGallery(View view) {
		Intent i = new Intent(getApplicationContext(), GalleryExampleActivity.class);
		startActivity(i); 		
    }

    public void showGridGallery(View view) {
		Intent i = new Intent(getApplicationContext(), GridGalleryExampleActivity.class);
		startActivity(i); 		
    }
    
    public void showDeviceImages(View view) {
		Intent i = new Intent(getApplicationContext(), DeviceGalleryExampleActivity.class);
		startActivity(i); 		
    }
