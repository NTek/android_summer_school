...
public class NotesContentProvider extends ContentProvider {
	...
	static {
		// All notes. URI ends with '/notes'
		// The last argument (NOTES) is a constant that is returned by the match() method if the pattern is recognized.
		sURIMatcher.addURI(AUTHORITY, BASE_PATH, NOTES);
		// Single note: URI ends with '/notes/<number>'. Wild card for number is '#'
		// The last argument (NOTE_ID) is a constant that is returned by the match() method if the pattern is recognized.
