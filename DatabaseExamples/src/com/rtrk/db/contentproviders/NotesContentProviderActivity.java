...
public class NotesContentProviderActivity extends Activity implements LoaderCallbacks<Cursor>{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter = new SimpleCursorAdapter(this, R.layout.list_item,
				null, new String[] { NotesDbManager.TIMESTAMP,
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		CursorLoader loader = new CursorLoader(
				         ...
				         new String[] { NotesDbManager._ID, NotesDbManager.TIMESTAMP,
									NotesDbManager.TITLE, NotesDbManager.TEXT }, 
				         null, 
				         null, 
				         null);
				   return loader;
